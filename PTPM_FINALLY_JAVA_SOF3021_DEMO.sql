...
GO
INSERT [dbo].[giao_dich] ([ma], [hinh_thuc_thanh_toan], [ngay_thanh_toan], [trang_thai], [ngay_tao], [ngay_sua]) VALUES (1, N'GD3', 3, CAST(N'2023-04-27' AS Date), 1, CAST(N'2023-04-27' AS Date), CAST(N'2023-04-27' AS Date))
INSERT [dbo].[giao_dich] ([ma], [hinh_thuc_thanh_toan], [ngay_thanh_toan], [trang_thai], [ngay_tao], [ngay_sua]) VALUES (2, N'GD2', 2, CAST(N'2023-04-27' AS Date), 0, CAST(N'2023-04-27' AS Date), CAST(N'2023-04-27' AS Date))
INSERT [dbo].[giao_dich] ([ma], [hinh_thuc_thanh_toan], [ngay_thanh_toan], [trang_thai], [ngay_tao], [ngay_sua]) VALUES (3, N'GD1', 1, CAST(N'2023-04-27' AS Date), 1, CAST(N'2023-04-27' AS Date), CAST(N'2023-04-27' AS Date))
GO
...
INSERT [dbo].[tai_khoan] ([co_so_id], [phong_ban_id], [chuc_vu_id], [ma], [ten_tai_khoan], [mat_khau], [ho], [ten_dem], [ten], [gioi_tinh], [ngay_sinh], [email], [sdt], [cmnd], [trang_thai], [ngay_tao], [ngay_chinh_sua]) VALUES (1,1,1, N'TK4', N'Nguyen Duc Huynh', N'123123', N'Nguyen', N'Anh', N'Dung', 0, CAST(N'2004-02-19' AS Date), N'huynhf70@gmail.com', N'0944674146', N'944674146', 0, CAST(N'2023-04-27' AS Date), CAST(N'2023-04-27' AS Date))
GO
