...
<div class="col-10 offset-1">
    <form class="mt-3 col-8 offset-2" action="/kich-thuoc/index">
        <div class="row">
            <div class="col-8">
    ...
    <div >
        <a href="/kich-thuoc/create"><button class="btn btn-light">Thêm mới</button></a>
    </div>
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination">
            <li class="page-item">
                <a class="page-link" href="/kich-thuoc/index?page=${data.number - 1}">Previous</a>
            </li>
            <c:forEach begin="1" end="${ data.totalPages }" var="page">
                <c:if test="${ page == 1 || page == data.totalPages || ( page >= data.number - 1 && page <= data.number + 1 ) }">
                    <li class="page-item">
                        <a class="page-link"
                           href="/kich-thuoc/index?page=${page}">
                                ${ page }
                        </a>
                    </li>
                </c:if>
            </c:forEach>
            <li class="page-item"><a class="page-link" href="/kich-thuoc/index?page=${data.number + 1}">Next</a></li>
        </ul>
    </nav>
</div>
